...
<template>
  <div :id="modalId" tabindex="-1"
    ...
    <div class="relative p-4 w-full max-w-md max-h-full absolute -translate-x-2/4 -translate-y-2/4 left-2/4 top-2/4"
      ...
      <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
        ...
        <div class="p-4 md:p-5 text-center">
          ...
          <button @click="onConfirmDelete" data-modal-hide="popup-modal" type="button"
